      ...
      <section className="detail-page pt-28 pb-16 px-6 min-h-screen bg-[#fffafa] flex flex-col items-center">
        ...
        <div className="detail-card max-w-4xl w-full bg-white rounded-3xl shadow-lg overflow-hidden grid md:grid-cols-2">
          ...
          <div className="p-8 flex flex-col">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">Conatct Supplier : {p.vendor.name|| "Delight your senses with this fabulous product fresh from local vendors."}</p>
            <p className="text-gray-600 leading-relaxed mb-6">{p.vendor.email|| "Delight your senses with this fabulous product fresh from local vendors."}</p>
